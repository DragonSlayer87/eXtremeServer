...
enum eventType { ONADDBOT = 0, ONBOTLIMIT, ONCLEARBANS, ONCLEARDEMOS, ONCOMMAND,
                 ...
                 IRC_ONCOMMANDUSAGEERROR, IRC_ONMSG, IRC_ONPRIVMSG, ONFLOOD, ONSHOT, ONHIT, ONUSERAUTH, ONSPYJOIN, ONSPYLEAVE, ONSPYSAY,
                 ONSPYTEAMSAY, ONROOT, ONPASSFLAG, ONCHAINSAW, ONSEEKERHIT, ONVOTEFORMAP, 
...
static const char * const eventNames[] = {
                 ...
                 "irc_oncommand", "irc_oncommandpermerror", "irc_oncommandunknown",
                 "irc_oncommandusageerror", "irc_onmsg", "irc_onprivmsg", "onflood", "onshot", "onhit", "onuserauth", "onspyjoin", "onspyleave", "onspysay",
                 "onspyteamsay", "onroot", "onpassflag", "onchainsaw", "onseekerhit", 
                 "onvoteformap", "custom event", "number of events" };
